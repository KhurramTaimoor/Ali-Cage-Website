        ...
        <div className="page-wrap">
          ...
          <div className="toolbar">
            ...
            <label className="date-filter-label">
              ...
              <input type="date" value={selectedDate} onChange={(e) => { setSelectedDate(e.target.value || today()); setShowAllReturns(false); }} />
            </label>
            ...
            <div className="inputModalBody">
              <div className="form-box">
                <div className="formTopLine returnTopLine">
                  ...
                  <div>
                    ...
                    <input className="basicInput" type="date" value={form.return_date} onChange={(e) => setForm((f) => ({ ...f, return_date: e.target.value }))} />
                  </div>
                  <div>
              ...
              <div className="paymentPanel">
                <div className="toolbar" style={{ marginBottom: 12 }}>
                  ...
                  <label className="date-filter-label">
                    <span>{t.selectDate}</span>
                    <input type="date" value={invoiceDate} onChange={(e) => { setInvoiceDate(e.target.value || today()); setShowAllInvoices(false); }} />
                  </label>
